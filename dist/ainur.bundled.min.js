		...
		change: function(newState)
		{
			...
			var next = function (i)
			{
				if(i < newStateFamily.length)
				{
					...
					console.log(i, stateName, that.states[stateName]);
